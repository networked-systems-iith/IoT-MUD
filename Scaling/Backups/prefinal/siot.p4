...
action store_state_sMAC(bit<22> val1)
{
  meta.flag_smac = 1;
  meta.state_smac = val1;
}
action store_state_sMAC_default(bit<22> val9)
{
  meta.state_default = val9;
}
action store_state_sMAC_default1(bit<22> val10)
{
	meta.flag_smac=0;
	meta.state_smac=val10;
}
action store_state_dMAC(bit<22> val2)
{
  meta.flag_dmac = 1;
  meta.state_dmac = val2;
}
action store_state_dMAC_default(bit<22> val11)
{
	meta.flag_dmac=0;
	meta.state_dmac=val11;
}
action store_state_typEth(bit<22> val3)
{
  meta.flag_type = 1;
  meta.state_type = val3;
}
action store_state_typEth_default(bit<22> val12)
{
	meta.flag_type=0;
	meta.state_type=val12;
}
action store_state_proto(bit<22> val4)
{
  meta.flag_proto = 1;
  meta.state_proto = val4;
}
action store_state_proto_default(bit<22> val13)
{
	meta.flag_proto=0;
	meta.state_proto=val13;
}
action store_state_sPort(bit<22> val5)
{
  meta.flag_sport = 1;
  meta.state_sport = val5;
}
action store_state_sPort_default(bit<22> val14)
{
	meta.flag_sport=0;
	meta.state_sport=val14;
}
action store_state_dPort(bit<22> val6)
{
  meta.flag_dport = 1;
  meta.state_dport = val6;
}
action store_state_dPort_default(bit<22> val15)
{
	meta.flag_dport=0;
	meta.state_dport=val15;
}
action store_state_srcIP(bit<22> val7)
{
  meta.flag_sip = 1;
  meta.state_sip = val7;
}
action store_state_srcIP_default(bit<22> val16)
{
	meta.flag_sip=0;
	meta.state_sip=val16;
}
action store_state_dstIP(bit<22> val8)
{
  meta.flag_dip = 1;
  meta.state_dip = val8;
}
action store_state_dstIP_default(bit<22> val17)
{
	meta.flag_dip=0;
